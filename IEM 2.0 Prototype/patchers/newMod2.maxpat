...
,
					"patching_rect" : [ 1000.0, 0.0, -950.0, 0.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"style" : "",
					"text" : "patcher fader.iem.maxpat @args faderTest @varname faderTest"
				}
...
,
					"style" : "",
					"text" : "patcher delayJSON.iem.maxpat @args delayTest @varname delayTest"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1000.0, 0.0, -950.0, 0.0 ],
					"style" : "",
					"text" : "fader.iem.maxpat faderTest @varname faderTest",
					"varname" : "fader.iem"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1000.0, 0.0, -950.0, 0.0 ],
					"style" : "",
					"text" : "delayJSON.iem.maxpat delayTest @varname delayTest",
